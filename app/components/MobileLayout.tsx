...
export default function MobileLayout({ children, showBottomNav = true }: MobileLayoutProps) {
  ...
  return (
    <main className="min-h-screen bg-card flex flex-col">
              ...
              <div className="flex items-center space-x-2 flex-1 min-w-0">
                ...
                <div className="flex items-center space-x-2 min-w-0">
                  ...
                  <button
                    ...
                    className="relative px-2 py-1 rounded-md text-xs font-bold btn-uppercase transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] overflow-hidden flex-shrink-0"
                    style={{
      ...
      {showBetaModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={() => setShowBetaModal(false)}>
          <div className="bg-white/90 backdrop-blur-xl rounded-md p-6 shadow-2xl border border-white/20 max-w-md w-full max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            {/* Header */}
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900">Beta Version</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-500/10 backdrop-blur-xl border border-yellow-200/50 text-yellow-700 px-4 py-3 rounded-md shadow-lg">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-bold mb-1">This is a Beta Release</p>
                    <p className="text-xs leading-relaxed">
                      PotFi is in active development. You may encounter bugs or unexpected behavior.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center space-x-2 text-sm text-gray-700">
                    <div className="w-1.5 h-1.5 bg-blue-600 rounded-full"></div>
                    <span>Rapid improvements</span>
                  </div>
                </div>
              </div>

              {/* Support Section */}
              <div className="bg-blue-500/10 backdrop-blur-xl border border-blue-200/50 rounded-md p-4 shadow-lg">
                <div className="flex items-center space-x-2 mb-2">
                  <MessageCircle className="w-4 h-4 text-blue-600" />
                  <p className="text-sm font-bold text-blue-900">Found a Bug?</p>
                </div>
                <p className="text-xs text-blue-700 mb-3 leading-relaxed">
                  Help us improve by reporting issues or getting support from our team.
                </p>
                <a
                  href="https://t.me/+_fXXrjRRqu41Yzdk"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-4 rounded-md text-sm transition-all duration-200 shadow-xl transform active:scale-95 backdrop-blur-sm flex items-center justify-center space-x-2"
                >
              ...
              <button
                onClick={() => setShowBetaModal(false)}
                className="w-full bg-gray-800/90 hover:bg-gray-900 text-white font-medium py-4 px-6 rounded-md text-base transition-all duration-200 shadow-xl transform active:scale-95 backdrop-blur-sm"
              >
                Got it, thanks!
              </button>
            </div>
